...
this.wordle.bundle = function(e) {
    ...
    ))), WORDLE_STATE_KEY = "nyt-wordle-state", xa = {
        boardState: null,
        evaluations: null,
        rowIndex: null,
        solution: null,
    ...
    function getLocalStorage() {
        var e = window.localStorage.getItem(WORDLE_STATE_KEY) || JSON.stringify(xa);
        return JSON.parse(e)
    }
    function setInLocalStorage(e) {
        var a = getLocalStorage();
        !function(e) {
            window.localStorage.setItem(WORDLE_STATE_KEY, JSON.stringify(e))
        }(va(a, e))
    }
    function Sa() {
    ...
    var _a = "mailto:jennaplusplus@gmail.com";
    function Ea(e) {
    ...
    var possibleSolutions = ['andres', 'calvin', 'marcus', 'declan', 'arthur', 'carlos', 'andrew', 'damian', 'joshua', 'weston', 'brooks', 'parker', 'justin', 'hunter', 'carson', 'kayden', 'elliot', 'edward', 'jeremy', 'kaiden', 'legend', 'miguel', 'easton', 'xavier', 'victor', 'carter', 'daniel', 'karter', 'joseph', 'samuel', 'thiago', 'josiah', 'bryson', 'cooper', 'holden', 'walker', 'connor', 'landon', 'emilio', 'xander', 'graham', 'camden', 'matteo', 'adriel', 'tucker', 'george', 'pierce', 'austin', 'steven', 'matias']
    ...
    var debutDate = new Date(2022,7,31,0,0,0,0); // september 1 (with offset)
    function Ba(e, a) {
        var s = new Date(e)
  ...
  ***************************************************************************** */
    ...
    Qs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Guess the <strong>BABYL</strong> in six tries. Until otherwise specified, each <strong>BABYL</strong> represents a name that has <strong>NOT</strong> been chosen for Baby Boy Petersen.</p>     <p>Each guess must be a valid six-letter boy\'s name, based on the top 1000 boys\' names from the SSA list in 2020. Hit the enter button to submit.</p>\n      <p>After each guess, the color of the tiles will change to show how close your guess was to the word.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="w" evaluation="correct" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="s"></game-tile>\n            <game-tile letter="t"></game-tile>\n            <game-tile letter="o"></game-tile>\n  <game-tile letter="n"></game-tile>\n          </div>\n          <p>The letter <strong>W</strong> is in the word and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="n" evaluation="present" reveal></game-tile>\n            <game-tile letter="d"></game-tile>\n            <game-tile letter="r"></game-tile>\n            <game-tile letter="e"></game-tile>\n   <game-tile letter="s"></game-tile>\n        </div>\n          <p>The letter <strong>N</strong> is in the word but in the wrong spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="j"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="r"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="m" evaluation="absent" reveal></game-tile>\n  <game-tile letter="y"></game-tile>\n         </div>\n          <p>The letter <strong>M</strong> is not in the word in any spot.</p>\n        </div>\n      </div>\n      <p><strong>A new BABYL will be available each day!</strong> When baby arrives, you will be instructed on how to reveal the <strong>ONE TRUE BABYL!</strong></p>\n    </div>\n  </section>\n';
    var et = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
